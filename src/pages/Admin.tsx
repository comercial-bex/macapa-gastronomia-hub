  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="p-4 border-t border-white/10 space-y-3">
        <Link to="/admin/perfil" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-2 py-2 rounded-md hover:bg-white/10 transition-colors">
          <div className="w-9 h-9 rounded-full bg-white/10 border border-white/10 overflow-hidden flex items-center justify-center flex-shrink-0">
  ...
  return (
    <div className="min-h-screen bg-background flex relative overflow-hidden" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] rounded-full bg-amber-500/15 blur-[100px] animate-blob animation-delay-2000" />
        <div className="absolute top-[40%] left-[30%] w-[30%] h-[30%] rounded-full bg-primary/12 blur-[80px] animate-blob animation-delay-4000" />
      </div>

      {/* Desktop sidebar */}
      <aside className="w-64 glass-effect border-r border-white/10 hidden lg:flex flex-col relative z-10">
        <SidebarContent />
      </aside>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-0 top-0 bottom-0 z-50 w-64 glass-effect border-r border-white/10 flex flex-col"
            >
              <SidebarContent />
            </motion.aside>
          </>
      ...
      <div className="flex-1 overflow-auto lg:pt-0 pt-14 relative z-10">
